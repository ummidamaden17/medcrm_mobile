...
class ExpencesListScreen extends StatefulWidget {
  const ExpencesListScreen({Key? key}) : super(key: key);

  @override
  State<ExpencesListScreen> createState() => _EmployeeListPageState();
}

class _EmployeeListPageState extends State<ExpencesListScreen> {
  int currentPage = 1;
  int itemsPerPage = 10;
