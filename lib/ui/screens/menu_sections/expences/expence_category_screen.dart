...
class ExpenceCategoryScreen extends StatefulWidget {
  const ExpenceCategoryScreen({Key? key}) : super(key: key);

  @override
  State<ExpenceCategoryScreen> createState() => _ExpenceCategoryScreen();
}

class _ExpenceCategoryScreen extends State<ExpenceCategoryScreen> {
  int currentPage = 1;
  int itemsPerPage = 10;
