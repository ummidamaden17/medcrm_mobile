...
class CashReportsScreen extends StatefulWidget {
  const CashReportsScreen({Key? key}) : super(key: key);

  @override
  State<CashReportsScreen> createState() => _CashReportsScreen();
}

class _CashReportsScreen extends State<CashReportsScreen> {
  int currentPage = 1;
  int itemsPerPage = 10;
