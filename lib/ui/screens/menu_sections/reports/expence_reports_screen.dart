...
class ExpenceReportsScreen extends StatefulWidget {
  const ExpenceReportsScreen({Key? key}) : super(key: key);

  @override
  State<ExpenceReportsScreen> createState() => _ExpenceReportsScreen();
}

class _ExpenceReportsScreen extends State<ExpenceReportsScreen> {
  int currentPage = 1;
  int itemsPerPage = 10;
  List<bool> checked = List.generate(18, (_) => false);
  final List<String> employees = List.generate(18, (_) => '900С');
