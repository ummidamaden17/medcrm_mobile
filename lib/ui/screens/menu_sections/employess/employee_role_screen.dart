...
class EmployeeRoleScreen extends StatefulWidget {
  const EmployeeRoleScreen({Key? key}) : super(key: key);

  @override
  State<EmployeeRoleScreen> createState() => _EmployeeRoleScreen();
}

class _EmployeeRoleScreen extends State<EmployeeRoleScreen> {
  int currentPage = 1;
  int itemsPerPage = 10;
