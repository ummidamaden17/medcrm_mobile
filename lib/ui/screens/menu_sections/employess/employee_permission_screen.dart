...
class EmployeePermissionScreen extends StatefulWidget {
  const EmployeePermissionScreen({Key? key}) : super(key: key);

  @override
  State<EmployeePermissionScreen> createState() => _EmployeePermissionScreen();
}

class _EmployeePermissionScreen extends State<EmployeePermissionScreen> {
  int currentPage = 1;
  int itemsPerPage = 10;
