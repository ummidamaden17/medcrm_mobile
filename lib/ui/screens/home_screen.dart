...
import 'menu_sections/employess/employee_edit_page.dart';
import 'menu_sections/employess/modals/employee_delete_modal.dart';
...
class HomeScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(body: Column(children: [Expanded(child: EmployeePage())]));
  }
}
